...
dx_dN0_U2*g_D1D2 + pow(dx_dN0_U2, 2)*g_D2D2;
  ...
  double h01 = 
dx_dN0_U0*dx_dN2_U0*g_D0D0 + dx_dN0_U0*dx_dN2_U1*g_D0D1 + dx_dN0_U0*
dx_dN2_U2*g_D0D2 + dx_dN0_U1*dx_dN2_U0*g_D0D1 + dx_dN0_U1*dx_dN2_U1*
g_D1D1 + dx_dN0_U1*dx_dN2_U2*g_D1D2 + dx_dN0_U2*dx_dN2_U0*g_D0D2 +
dx_dN0_U2*dx_dN2_U1*g_D1D2 + dx_dN0_U2*dx_dN2_U2*g_D2D2;
