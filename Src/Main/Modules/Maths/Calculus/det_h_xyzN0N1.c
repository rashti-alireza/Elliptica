...
g_D2D2[ijk];
  ...
  double h01 = 
dx_dN0_U0*dx_dN1_U0*g_D0D0[ijk] + dx_dN0_U0*dx_dN1_U1*g_D0D1[ijk] +
dx_dN0_U0*dx_dN1_U2*g_D0D2[ijk] + dx_dN0_U1*dx_dN1_U0*g_D0D1[ijk] +
dx_dN0_U1*dx_dN1_U1*g_D1D1[ijk] + dx_dN0_U1*dx_dN1_U2*g_D1D2[ijk] +
dx_dN0_U2*dx_dN1_U0*g_D0D2[ijk] + dx_dN0_U2*dx_dN1_U1*g_D1D2[ijk] +
dx_dN0_U2*dx_dN1_U2*g_D2D2[ijk];
