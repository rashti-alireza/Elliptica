...
FOR_ALL_ijk
{
  ...
  KS__beta_D0[ijk] = frda_ks_c(x,y,z)*frda_ks_kt(x, y, z)*frda_ks_k0(x, y, z);
  KS__beta_D1[ijk] = frda_ks_c(x,y,z)*frda_ks_kt(x, y, z)*frda_ks_k1(x, y, z);
  KS__beta_D2[ijk] = frda_ks_c(x,y,z)*frda_ks_kt(x, y, z)*frda_ks_k2(x, y, z);
  KS__alpha[ijk]   = 1./sqrt(1+frda_ks_c(x,y,z)*frda_ks_k0(x, y, z)*frda_ks_k0(x, y, z));
}
