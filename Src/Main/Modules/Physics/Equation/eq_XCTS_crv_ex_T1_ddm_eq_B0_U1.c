...
F00_U1/pow(psi[ijk], 4);
  ...
  double F1_U1 =
0.66666666666666663*(-dtrK_D0[ijk]*igConf_U0U1[ijk] - dtrK_D1[ijk]*
igConf_U1U1[ijk] - dtrK_D2[ijk]*igConf_U1U2[ijk])/psi[ijk];



  double s_U1 =
-8*M_PI*JConfP_U1[ijk]/pow(psi[ijk], 3);



  double ell_U1 =
JConfC[ijk]*(F0_U1 + F1_U1);



  double F_eq_U1 =
2*alphaPsi[ijk]*(ell_U1 + s_U1);


  schur_F[schur_ijk] = F_eq_U1;
