...
void *eq_XCTS_curve_exc_T1_ddm_eq_B0_U2(void *vp1,void *vp2)
{
  ...
  double F00_U2 =
(AConfIJ_U0U0[ijk]*ChrisConf_U2D0D0[ijk] + 2.0*AConfIJ_U0U1[ijk]*
ChrisConf_U2D0D1[ijk] + AConfIJ_U0U2[ijk]*ChrisConf_U0D0D0[ijk] +
AConfIJ_U0U2[ijk]*ChrisConf_U1D0D1[ijk] + 3.0*AConfIJ_U0U2[ijk]*
ChrisConf_U2D0D2[ijk] + AConfIJ_U1U1[ijk]*ChrisConf_U2D1D1[ijk] +
AConfIJ_U1U2[ijk]*ChrisConf_U0D0D1[ijk] + AConfIJ_U1U2[ijk]*
ChrisConf_U1D1D1[ijk] + 3.0*AConfIJ_U1U2[ijk]*ChrisConf_U2D1D2[ijk] +
AConfIJ_U2U2[ijk]*ChrisConf_U0D0D2[ijk] + AConfIJ_U2U2[ijk]*
ChrisConf_U1D1D2[ijk] + 2.0*AConfIJ_U2U2[ijk]*ChrisConf_U2D2D2[ijk] +
dAConfIJ_U0U2D0[ijk] + dAConfIJ_U1U2D1[ijk] + dAConfIJ_U2U2D2[ijk])/
pow(psi[ijk], 3);
...
F00_U2/pow(psi[ijk], 4);
  ...
  double F1_U2 =
0.66666666666666663*(-dtrK_D0[ijk]*igConf_U0U2[ijk] - dtrK_D1[ijk]*
igConf_U1U2[ijk] - dtrK_D2[ijk]*igConf_U2U2[ijk])/psi[ijk];



  double s_U2 =
-8*M_PI*JConfP_U2[ijk]/pow(psi[ijk], 3);



  double ell_U2 =
JConfC[ijk]*(F0_U2 + F1_U2);



  double F_eq_U2 =
2*alphaPsi[ijk]*(ell_U2 + s_U2);
