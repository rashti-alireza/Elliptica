...
F00_U2/pow(psi[ijk], 4);
  ...
  double F1_U2 = 
-(8*M_PI*JConf_U2[ijk] + 0.66666666666666663*pow(psi[ijk], 2)*
(dtrK_D0[ijk]*igConf_U0U2[ijk] + dtrK_D1[ijk]*igConf_U1U2[ijk] + 
dtrK_D2[ijk]*igConf_U2U2[ijk]))/pow(psi[ijk], 3);

  double F_eq_U2 = 
2*alphaPsi[ijk]*(F0_U2 + F1_U2);
