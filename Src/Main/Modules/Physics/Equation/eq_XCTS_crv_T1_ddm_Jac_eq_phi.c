...
att*pow(rho0[ijk]/rhoc - 1, 4);
  ...
  double t0_b =
(polish_b + rho0[ijk])*(JJphi_D0D0*igConf_U0U0[ijk] + 2.0*JJphi_D0D1*
igConf_U0U1[ijk] + 2.0*JJphi_D0D2*igConf_U0U2[ijk] + JJphi_D1D1*
igConf_U1U1[ijk] + 2.0*JJphi_D1D2*igConf_U1U2[ijk] + JJphi_D2D2*
igConf_U2U2[ijk]);

  double t1_b =
-rho0[ijk]*(ChrisConf_U0D0D0[ijk]*Jphi_D0*igConf_U0U0[ijk] + 2.0*
ChrisConf_U0D0D1[ijk]*Jphi_D0*igConf_U0U1[ijk] + 2.0*
ChrisConf_U0D0D2[ijk]*Jphi_D0*igConf_U0U2[ijk] + ChrisConf_U0D1D1[ijk]*
Jphi_D0*igConf_U1U1[ijk] + 2.0*ChrisConf_U0D1D2[ijk]*Jphi_D0*
igConf_U1U2[ijk] + ChrisConf_U0D2D2[ijk]*Jphi_D0*igConf_U2U2[ijk] +
ChrisConf_U1D0D0[ijk]*Jphi_D1*igConf_U0U0[ijk] + 2.0*
ChrisConf_U1D0D1[ijk]*Jphi_D1*igConf_U0U1[ijk] + 2.0*
ChrisConf_U1D0D2[ijk]*Jphi_D1*igConf_U0U2[ijk] + ChrisConf_U1D1D1[ijk]*
Jphi_D1*igConf_U1U1[ijk] + 2.0*ChrisConf_U1D1D2[ijk]*Jphi_D1*
igConf_U1U2[ijk] + ChrisConf_U1D2D2[ijk]*Jphi_D1*igConf_U2U2[ijk] +
ChrisConf_U2D0D0[ijk]*Jphi_D2*igConf_U0U0[ijk] + 2.0*
ChrisConf_U2D0D1[ijk]*Jphi_D2*igConf_U0U1[ijk] + 2.0*
ChrisConf_U2D0D2[ijk]*Jphi_D2*igConf_U0U2[ijk] + ChrisConf_U2D1D1[ijk]*
Jphi_D2*igConf_U1U1[ijk] + 2.0*ChrisConf_U2D1D2[ijk]*Jphi_D2*
igConf_U1U2[ijk] + ChrisConf_U2D2D2[ijk]*Jphi_D2*igConf_U2U2[ijk]);
...
att*pow(rho0[ijk]/rhoc - 1, 4);
  ...
  double t0_e =
(polish_e + rho0[ijk])*(JJphi_D0D0*igConf_U0U0[ijk] + 2.0*JJphi_D0D1*
igConf_U0U1[ijk] + 2.0*JJphi_D0D2*igConf_U0U2[ijk] + JJphi_D1D1*
igConf_U1U1[ijk] + 2.0*JJphi_D1D2*igConf_U1U2[ijk] + JJphi_D2D2*
igConf_U2U2[ijk]);
...
t0_e + t1_e + t2_e;
  ...
  if(IsItCovering(patch,"left_central_box") || IsItCovering(patch,"right_central_box"))
  {
    ...
    if (X_of_x(X,NS_center,patch))
    {
      ...
      DDM_SCHUR_JACOBIAN_EQ_Bpart_OPEN
      	 schur_B[schur_ijk][schur_lmn] += Att_Con_Num*d_df[lmn];
      DDM_SCHUR_JACOBIAN_EQ_Bpart_CLOSE
