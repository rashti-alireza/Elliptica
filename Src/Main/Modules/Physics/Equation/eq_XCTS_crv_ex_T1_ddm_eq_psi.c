...
ChrisConf_U2D2D2[ijk]*dpsi_D2[ijk]*igConf_U2U2[ijk] + (1.0/8.0)*aij2/
pow(psi[ijk], 3) + ddpsi_D0D0[ijk]*igConf_U0U0[ijk] + 2.0*
ddpsi_D0D1[ijk]*igConf_U0U1[ijk] + 2.0*ddpsi_D0D2[ijk]*
igConf_U0U2[ijk] + ddpsi_D1D1[ijk]*igConf_U1U1[ijk] + 2.0*
ddpsi_D1D2[ijk]*igConf_U1U2[ijk] + ddpsi_D2D2[ijk]*igConf_U2U2[ijk] -
1.0/12.0*psi[ijk]*psi4*pow(trK[ijk], 2) - 1.0/8.0*psi[ijk]*
trRicciConf[ijk];

  double src =
2*M_PI*EConfP[ijk]/psi[ijk];
