...
kd[ijk==lmn]*(0.875*aij2_B/psi4_B + (5.0/12.0)*psi4_B*pow(trK[ijk], 2) +
(1.0/8.0)*trRicciConf[ijk]);

  double t2_b =
-2*M_PI*EConfP[ijk]*kd[ijk==lmn]/pow(psi[ijk], 2);

  double Bpart =
EConfC[ijk]*t1_b + t2_b;
...
JJpsi_D0D2*igConf_U0U2[ijk] + JJpsi_D1D1*igConf_U1U1[ijk] + 2.0*
JJpsi_D1D2*igConf_U1U2[ijk] + JJpsi_D2D2*igConf_U2U2[ijk] -
kd[ijk==lmn]*(0.875*aij2_E/psi4_E + (5.0/12.0)*psi4_E*pow(trK[ijk], 2) +
(1.0/8.0)*trRicciConf[ijk]);
...
EConfC[ijk]*t1_e + t2_e;
  ...
  Free_Jacobian(JJpsi_D0D0)
  Free_Jacobian(JJpsi_D0D1)
  Free_Jacobian(JJpsi_D0D2)
  Free_Jacobian(JJpsi_D1D1)
  Free_Jacobian(JJpsi_D1D2)
  Free_Jacobian(JJpsi_D2D2)
  Footer_Jacobian
