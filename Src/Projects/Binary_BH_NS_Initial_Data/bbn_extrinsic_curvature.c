...
void bbn_make_K_UiUj_and_dK_UiUj(Grid_T *const grid)
{
  ...
  for(p = 0; p < np; ++p)
  {
    ...
    ADD_FIELD_NoMem(dK_UiUj_U0U0D2)
    ADD_FIELD_NoMem(dK_UiUj_U0U0D0)
    ADD_FIELD_NoMem(dK_UiUj_U0U0D1)
    ADD_FIELD_NoMem(dK_UiUj_U1U1D2)
    ADD_FIELD_NoMem(dK_UiUj_U1U1D0)
    ADD_FIELD_NoMem(dK_UiUj_U1U1D1)
    ADD_FIELD_NoMem(dK_UiUj_U0U2D0)
    ADD_FIELD_NoMem(dK_UiUj_U0U2D1)
    ADD_FIELD_NoMem(dK_UiUj_U0U2D2)
    ADD_FIELD_NoMem(dK_UiUj_U1U2D1)
    ADD_FIELD_NoMem(dK_UiUj_U1U2D0)
    ADD_FIELD_NoMem(dK_UiUj_U2U2D0)
    ADD_FIELD_NoMem(dK_UiUj_U1U2D2)
    ADD_FIELD_NoMem(dK_UiUj_U2U2D1)
    ADD_FIELD_NoMem(dK_UiUj_U2U2D2)
    ADD_FIELD_NoMem(dK_UiUj_U0U1D2)
    ADD_FIELD_NoMem(dK_UiUj_U0U1D1)
    ADD_FIELD_NoMem(dK_UiUj_U0U1D0)
