...
return
/* mcode in progress ... */
-0.5*Power(Pattern(a,BH),2) + 0.5*Power(bbn_ks_X(x,y,z),2) + 0.5*
Power(bbn_ks_Y(x,y,z),2) + 0.5*Power(bbn_ks_Z(x,y,z),2) + 0.5*Sqrt(4*
Power(Pattern(a,BH),2)*Power(bbn_ks_Z(x,y,z),2) + Power(-
Power(Pattern(a,BH),2) + Power(bbn_ks_X(x,y,z),2) + 
Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2))
;
}
KS_func_def_macro(dR_D2) KS_func_args_macro
{
return
/* mcode in progress ... */
1.*Hold(D(bbn_ks_X(x,y,z),z))*bbn_ks_X(x,y,z) + 1.*Hold(D(bbn_ks_Y(x,y,z),z))*bbn_ks_Y(x,y,z) + 
...
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2))
;
}
KS_func_def_macro(dR_D1) KS_func_args_macro
{
return
/* mcode in progress ... */
1.*Hold(D(bbn_ks_X(x,y,z),y))*bbn_ks_X(x,y,z) + 1.*Hold(D(bbn_ks_Y(x,y,z),y))*bbn_ks_Y(x,y,z) + 
...
return
/* mcode in progress ... */
1.*Hold(D(bbn_ks_X(x,y,z),x))*bbn_ks_X(x,y,z) + 1.*Hold(D(bbn_ks_Y(x,y,z),x))*bbn_ks_Y(x,y,z) + 
...
return
/* mcode in progress ... */
1.*Hold(D(bbn_ks_X(x,y,z),y))*Hold(D(bbn_ks_X(x,y,z),z)) + 1.*Hold(D(bbn_ks_Y(x,y,z),y))*
...
Hold(D(bbn_ks_Z(x,y,z),y,z))*bbn_ks_Z(x,y,z))*(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2))))/Sqrt(4*
Power(Pattern(a,BH),2)*Power(bbn_ks_Z(x,y,z),2) + Power(-
Power(Pattern(a,BH),2) + Power(bbn_ks_X(x,y,z),2) + 
Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2))
;
...
return
/* mcode in progress ... */
1.*Hold(D(bbn_ks_X(x,y,z),x))*Hold(D(bbn_ks_X(x,y,z),z)) + 1.*Hold(D(bbn_ks_Y(x,y,z),x))*
...
Hold(D(bbn_ks_Y(x,y,z),z))*bbn_ks_Y(x,y,z) + Hold(D(bbn_ks_Z(x,y,z),z))*bbn_ks_Z(x,y,z)) + 2*
(Hold(D(bbn_ks_X(x,y,z),x))*Hold(D(bbn_ks_X(x,y,z),z)) + Hold(D(bbn_ks_Y(x,y,z),x))*
Hold(D(bbn_ks_Y(x,y,z),z)) + Hold(D(bbn_ks_Z(x,y,z),x))*Hold(D(bbn_ks_Z(x,y,z),z)) + 
Hold(D(bbn_ks_X(x,y,z),x,z))*bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),x,z))*bbn_ks_Y(x,y,z) + 
Hold(D(bbn_ks_Z(x,y,z),x,z))*bbn_ks_Z(x,y,z))*(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2))))/Sqrt(4*
Power(Pattern(a,BH),2)*Power(bbn_ks_Z(x,y,z),2) + Power(-
Power(Pattern(a,BH),2) + Power(bbn_ks_X(x,y,z),2) + 
Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2))
...
return
/* mcode in progress ... */
1.*Hold(D(bbn_ks_X(x,y,z),x))*Hold(D(bbn_ks_X(x,y,z),y)) + 1.*Hold(D(bbn_ks_Y(x,y,z),x))*
...
(Hold(D(bbn_ks_X(x,y,z),x))*Hold(D(bbn_ks_X(x,y,z),y)) + Hold(D(bbn_ks_Y(x,y,z),x))*
Hold(D(bbn_ks_Y(x,y,z),y)) + Hold(D(bbn_ks_Z(x,y,z),x))*Hold(D(bbn_ks_Z(x,y,z),y)) + 
Hold(D(bbn_ks_X(x,y,z),x,y))*bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),x,y))*bbn_ks_Y(x,y,z) + 
Hold(D(bbn_ks_Z(x,y,z),x,y))*bbn_ks_Z(x,y,z))*(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2))))/Sqrt(4*
Power(Pattern(a,BH),2)*Power(bbn_ks_Z(x,y,z),2) + Power(-
Power(Pattern(a,BH),2) + Power(bbn_ks_X(x,y,z),2) + 
Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2))
...
(Hold(D(bbn_ks_X(x,y,z),x))*bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),x))*bbn_ks_Y(x,y,z) + 
Hold(D(bbn_ks_Z(x,y,z),x))*bbn_ks_Z(x,y,z))*(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)),2)*(12*
...
Power(bbn_ks_Z(x,y,z),2) + Power(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2)) + 
(12.*Power(Hold(D(bbn_ks_X(x,y,z),z))*bbn_ks_X(x,y,z)*(-1.*Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)) + 
Hold(D(bbn_ks_Y(x,y,z),z))*bbn_ks_Y(x,y,z)*(-1.*Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)) + 
Hold(D(bbn_ks_Z(x,y,z),z))*bbn_ks_Z(x,y,z)*(Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)),3))/
(Sqrt(Power(Pattern(a,BH),4) - 2*Power(Pattern(a,BH),2)*
(Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) - Power(bbn_ks_Z(x,y,z),2)) + 
Power(Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2))*
Power(Power(Pattern(a,BH),4) + Power(bbn_ks_X(x,y,z),4) + 
Power(bbn_ks_Y(x,y,z),4) + 2.*Power(bbn_ks_Y(x,y,z),2)*Power(bbn_ks_Z(x,y,z),2) + 
Power(bbn_ks_Z(x,y,z),4) + Power(Pattern(a,BH),2)*(-2.*
Power(bbn_ks_X(x,y,z),2) - 2.*Power(bbn_ks_Y(x,y,z),2) + 2.*Power(bbn_ks_Z(x,y,z),2)) + 
Power(bbn_ks_X(x,y,z),2)*(2.*Power(bbn_ks_Y(x,y,z),2) + 2.*Power(bbn_ks_Z(x,y,z),2)),2))
;
}
KS_func_def_macro(dddR_D2D2D0) KS_func_args_macro
{
...
Power(bbn_ks_Z(x,y,z),2) + Power(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2)) + 
(12.*Power(Hold(D(bbn_ks_X(x,y,z),x))*bbn_ks_X(x,y,z)*(-1.*Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)) + 
Hold(D(bbn_ks_Y(x,y,z),x))*bbn_ks_Y(x,y,z)*(-1.*Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)) + 
Hold(D(bbn_ks_Z(x,y,z),x))*bbn_ks_Z(x,y,z)*(Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)),3))/
(Sqrt(Power(Pattern(a,BH),4) - 2*Power(Pattern(a,BH),2)*
...
return
/* mcode in progress ... */
1.*Hold(D(bbn_ks_X(x,y,z),z))*Hold(D(bbn_ks_X(x,y,z),x,y)) + 1.*
Hold(D(bbn_ks_X(x,y,z),y))*Hold(D(bbn_ks_X(x,y,z),x,z)) + 1.*Hold(D(bbn_ks_X(x,y,z),x))*
Hold(D(bbn_ks_X(x,y,z),y,z)) + 1.*Hold(D(bbn_ks_Y(x,y,z),z))*Hold(D(bbn_ks_Y(x,y,z),x,y)) + 
1.*Hold(D(bbn_ks_Y(x,y,z),y))*Hold(D(bbn_ks_Y(x,y,z),x,z)) + 1.*
Hold(D(bbn_ks_Y(x,y,z),x))*Hold(D(bbn_ks_Y(x,y,z),y,z)) + 1.*Hold(D(bbn_ks_Z(x,y,z),z))*
Hold(D(bbn_ks_Z(x,y,z),x,y)) + 1.*Hold(D(bbn_ks_Z(x,y,z),y))*Hold(D(bbn_ks_Z(x,y,z),x,z)) + 
1.*Hold(D(bbn_ks_Z(x,y,z),x))*Hold(D(bbn_ks_Z(x,y,z),y,z)) + 1.*
Hold(D(bbn_ks_X(x,y,z),x,y,z))*bbn_ks_X(x,y,z) + 1.*Hold(D(bbn_ks_Y(x,y,z),x,y,z))*
...
4*Hold(D(bbn_ks_Z(x,y,z),x,y,z))*Power(Pattern(a,BH),2)*bbn_ks_Z(x,y,z) + 4*
(Hold(D(bbn_ks_X(x,y,z),z))*bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),z))*bbn_ks_Y(x,y,z) + 
Hold(D(bbn_ks_Z(x,y,z),z))*bbn_ks_Z(x,y,z))*(Hold(D(bbn_ks_X(x,y,z),x))*
Hold(D(bbn_ks_X(x,y,z),y)) + Hold(D(bbn_ks_Y(x,y,z),x))*Hold(D(bbn_ks_Y(x,y,z),y)) + 
Hold(D(bbn_ks_Z(x,y,z),x))*Hold(D(bbn_ks_Z(x,y,z),y)) + Hold(D(bbn_ks_X(x,y,z),x,y))*
bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),x,y))*bbn_ks_Y(x,y,z) + Hold(D(bbn_ks_Z(x,y,z),x,y))*
bbn_ks_Z(x,y,z)) + 4*(Hold(D(bbn_ks_X(x,y,z),y))*bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),y))*
bbn_ks_Y(x,y,z) + Hold(D(bbn_ks_Z(x,y,z),y))*bbn_ks_Z(x,y,z))*(Hold(D(bbn_ks_X(x,y,z),x))*
Hold(D(bbn_ks_X(x,y,z),z)) + Hold(D(bbn_ks_Y(x,y,z),x))*Hold(D(bbn_ks_Y(x,y,z),z)) + 
Hold(D(bbn_ks_Z(x,y,z),x))*Hold(D(bbn_ks_Z(x,y,z),z)) + Hold(D(bbn_ks_X(x,y,z),x,z))*
bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),x,z))*bbn_ks_Y(x,y,z) + Hold(D(bbn_ks_Z(x,y,z),x,z))*
bbn_ks_Z(x,y,z)) + 4*(Hold(D(bbn_ks_X(x,y,z),x))*bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),x))*
bbn_ks_Y(x,y,z) + Hold(D(bbn_ks_Z(x,y,z),x))*bbn_ks_Z(x,y,z))*(Hold(D(bbn_ks_X(x,y,z),y))*
Hold(D(bbn_ks_X(x,y,z),z)) + Hold(D(bbn_ks_Y(x,y,z),y))*Hold(D(bbn_ks_Y(x,y,z),z)) + 
Hold(D(bbn_ks_Z(x,y,z),y))*Hold(D(bbn_ks_Z(x,y,z),z)) + Hold(D(bbn_ks_X(x,y,z),y,z))*
bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),y,z))*bbn_ks_Y(x,y,z) + Hold(D(bbn_ks_Z(x,y,z),y,z))*
bbn_ks_Z(x,y,z)) + 2*(Hold(D(bbn_ks_X(x,y,z),z))*Hold(D(bbn_ks_X(x,y,z),x,y)) + 
Hold(D(bbn_ks_X(x,y,z),y))*Hold(D(bbn_ks_X(x,y,z),x,z)) + Hold(D(bbn_ks_X(x,y,z),x))*
Hold(D(bbn_ks_X(x,y,z),y,z)) + Hold(D(bbn_ks_Y(x,y,z),z))*Hold(D(bbn_ks_Y(x,y,z),x,y)) + 
Hold(D(bbn_ks_Y(x,y,z),y))*Hold(D(bbn_ks_Y(x,y,z),x,z)) + Hold(D(bbn_ks_Y(x,y,z),x))*
Hold(D(bbn_ks_Y(x,y,z),y,z)) + Hold(D(bbn_ks_Z(x,y,z),z))*Hold(D(bbn_ks_Z(x,y,z),x,y)) + 
Hold(D(bbn_ks_Z(x,y,z),y))*Hold(D(bbn_ks_Z(x,y,z),x,z)) + Hold(D(bbn_ks_Z(x,y,z),x))*
Hold(D(bbn_ks_Z(x,y,z),y,z)) + Hold(D(bbn_ks_X(x,y,z),x,y,z))*bbn_ks_X(x,y,z) + 
Hold(D(bbn_ks_Y(x,y,z),x,y,z))*bbn_ks_Y(x,y,z) + Hold(D(bbn_ks_Z(x,y,z),x,y,z))*
bbn_ks_Z(x,y,z))*(-Power(Pattern(a,BH),2) + Power(bbn_ks_X(x,y,z),2) + 
Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2))))/Sqrt(4*Power(Pattern(a,BH),2)*
Power(bbn_ks_Z(x,y,z),2) + Power(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2))
...
Power(bbn_ks_Z(x,y,z),2) + Power(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2),2)) + 
(12.*Power(Hold(D(bbn_ks_X(x,y,z),y))*bbn_ks_X(x,y,z)*(-1.*Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)) + 
Hold(D(bbn_ks_Y(x,y,z),y))*bbn_ks_Y(x,y,z)*(-1.*Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)) + 
Hold(D(bbn_ks_Z(x,y,z),y))*bbn_ks_Z(x,y,z)*(Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)),3))/
(Sqrt(Power(Pattern(a,BH),4) - 2*Power(Pattern(a,BH),2)*
...
1.*Hold(D(bbn_ks_Z(x,y,z),x))*Hold(D(bbn_ks_Z(x,y,z),y,z)) + 1.*
Hold(D(bbn_ks_X(x,y,z),x,y,z))*bbn_ks_X(x,y,z) + 1.*Hold(D(bbn_ks_Y(x,y,z),x,y,z))*
bbn_ks_Y(x,y,z) + 1.*Hold(D(bbn_ks_Z(x,y,z),x,y,z))*bbn_ks_Z(x,y,z) + (0.5*(-12*
Hold(D(bbn_ks_Z(x,y,z),x))*Power(Pattern(a,BH),2)*bbn_ks_Z(x,y,z) - 6*
(Hold(D(bbn_ks_X(x,y,z),x))*bbn_ks_X(x,y,z) + Hold(D(bbn_ks_Y(x,y,z),x))*bbn_ks_Y(x,y,z) + 
Hold(D(bbn_ks_Z(x,y,z),x))*bbn_ks_Z(x,y,z))*(-Power(Pattern(a,BH),2) + 
Power(bbn_ks_X(x,y,z),2) + Power(bbn_ks_Y(x,y,z),2) + Power(bbn_ks_Z(x,y,z),2)))*(4*
