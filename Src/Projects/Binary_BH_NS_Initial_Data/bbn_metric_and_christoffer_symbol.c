...
void bbn_make_metric_and_Gamma_and_derivatives(Grid_T *const grid)
{
  ...
  for(p = 0; p < np; ++p)
  {
    ...
    READ_v(gammaI_U1U1)
    READ_v(gammaI_U1U2)
    READ_v(dgamma_D2D2D2)
    READ_v(dgamma_D2D2D1)
    READ_v(dgamma_D0D1D1)
    READ_v(dgamma_D1D2D2)
    READ_v(dgamma_D1D2D0)
    READ_v(dgamma_D1D1D2)
    READ_v(dgamma_D1D1D1)
    READ_v(dgamma_D1D1D0)
    READ_v(dgamma_D2D2D0)
    READ_v(dgamma_D0D2D1)
    READ_v(dgamma_D0D2D0)
    READ_v(dgamma_D0D2D2)
    READ_v(dgamma_D1D2D1)
    READ_v(dgamma_D0D1D2)
    READ_v(dgamma_D0D0D2)
    READ_v(dgamma_D0D0D1)
    READ_v(dgamma_D0D0D0)
    READ_v(dgamma_D0D1D0)
    ...
    ADD_FIELD(dGamma_U1D0D1D2)
    ADD_FIELD(dGamma_U1D2D2D2)
    ADD_FIELD(dGamma_U1D0D1D0)
    ADD_FIELD(dGamma_U1D0D1D1)
    ADD_FIELD(dGamma_U2D0D2D2)
    ADD_FIELD(dGamma_U2D1D1D2)
    ADD_FIELD(dGamma_U2D0D0D1)
    ADD_FIELD(dGamma_U1D0D0D2)
    ADD_FIELD(dGamma_U1D0D0D1)
    ADD_FIELD(dGamma_U1D0D0D0)
    ADD_FIELD(dGamma_U1D2D2D1)
    ADD_FIELD(dGamma_U1D0D2D1)
    ADD_FIELD(dGamma_U1D0D2D0)
    ADD_FIELD(dGamma_U1D0D2D2)
    ADD_FIELD(dGamma_U0D1D1D2)
    ADD_FIELD(dGamma_U0D1D1D0)
    ADD_FIELD(dGamma_U0D1D1D1)
    ADD_FIELD(dGamma_U2D0D1D2)
    ADD_FIELD(dGamma_U0D1D2D1)
    ADD_FIELD(dGamma_U0D1D2D0)
    ADD_FIELD(dGamma_U0D1D2D2)
    ADD_FIELD(dGamma_U2D2D2D0)
    ADD_FIELD(dGamma_U2D2D2D1)
    ADD_FIELD(dGamma_U2D2D2D2)
    ADD_FIELD(dGamma_U1D2D2D0)
    ADD_FIELD(dGamma_U0D0D2D0)
    ADD_FIELD(dGamma_U0D0D2D1)
    ADD_FIELD(dGamma_U0D0D2D2)
    ADD_FIELD(dGamma_U2D0D1D0)
    ADD_FIELD(dGamma_U1D1D2D0)
    ADD_FIELD(dGamma_U1D1D2D1)
    ADD_FIELD(dGamma_U1D1D2D2)
    ADD_FIELD(dGamma_U1D1D1D1)
    ADD_FIELD(dGamma_U0D0D0D2)
    ADD_FIELD(dGamma_U2D1D1D1)
    ADD_FIELD(dGamma_U0D0D0D0)
    ADD_FIELD(dGamma_U0D0D0D1)
    ADD_FIELD(dGamma_U2D1D1D0)
    ADD_FIELD(dGamma_U0D0D1D2)
    ADD_FIELD(dGamma_U0D0D1D1)
    ADD_FIELD(dGamma_U0D0D1D0)
    ADD_FIELD(dGamma_U0D2D2D2)
    ADD_FIELD(dGamma_U1D1D1D2)
    ADD_FIELD(dGamma_U0D2D2D0)
    ADD_FIELD(dGamma_U0D2D2D1)
    ADD_FIELD(dGamma_U2D0D0D2)
    ADD_FIELD(dGamma_U2D1D2D2)
    ADD_FIELD(dGamma_U2D0D1D1)
    ADD_FIELD(dGamma_U2D1D2D0)
    ADD_FIELD(dGamma_U2D0D2D0)
    ADD_FIELD(dGamma_U2D0D2D1)
    ADD_FIELD(dGamma_U1D1D1D0)
    ADD_FIELD(dGamma_U2D0D0D0)
...
static void build_metric_derivatives(Patch_T *const patch)
{
  ...
  ADD_FIELD(dgamma_D0D0D1)
  ADD_FIELD(dgamma_D0D0D0)
  ADD_FIELD(dgamma_D2D2D2)
  ADD_FIELD(dgamma_D0D0D2)
  ADD_FIELD(dgamma_D0D2D1)
  ADD_FIELD(dgamma_D1D1D0)
  ADD_FIELD(dgamma_D1D1D2)
  ADD_FIELD(dgamma_D2D2D0)
  ADD_FIELD(dgamma_D2D2D1)
  ADD_FIELD(dgamma_D0D1D0)
  ADD_FIELD(dgamma_D0D1D1)
  ADD_FIELD(dgamma_D0D1D2)
  ADD_FIELD(dgamma_D0D2D0)
  ADD_FIELD(dgamma_D1D1D1)
  ADD_FIELD(dgamma_D1D2D1)
  ADD_FIELD(dgamma_D1D2D2)
  ADD_FIELD(dgamma_D1D2D0)
  ADD_FIELD(dgamma_D0D2D2)
