...
void bbn_free_data_gammas(Grid_T *const grid)
{
  ...
  FOR_ALL_PATCHES(p,grid)
  {
    ...
    REALLOC_v_CALL_v(_gamma_D2D2)
    REALLOC_v_CALL_v(_gamma_D0D2)
    REALLOC_v_CALL_v(_gamma_D0D0)
    REALLOC_v_CALL_v(_gamma_D0D1)
    REALLOC_v_CALL_v(_gamma_D1D2)
    REALLOC_v_CALL_v(_gamma_D1D1)
    REALLOC_v_CALL_v(_gammaI_U0U2)
    REALLOC_v_CALL_v(_gammaI_U0U0)
    REALLOC_v_CALL_v(_gammaI_U0U1)
    REALLOC_v_CALL_v(_gammaI_U1U2)
    REALLOC_v_CALL_v(_gammaI_U1U1)
    REALLOC_v_CALL_v(_gammaI_U2U2)
...
static void populate_KSgammas_KSalpha_KSBeta(Patch_T *const patch)
{
  ...
  REALLOC_v_CALL_v(KSgamma_D2D2)
  REALLOC_v_CALL_v(KSgamma_D0D2)
  REALLOC_v_CALL_v(KSgamma_D0D0)
  REALLOC_v_CALL_v(KSgamma_D0D1)
  REALLOC_v_CALL_v(KSgamma_D1D2)
  REALLOC_v_CALL_v(KSgamma_D1D1)
  REALLOC_v_CALL_v(KSgammaI_U0U2)
  REALLOC_v_CALL_v(KSgammaI_U0U0)
  REALLOC_v_CALL_v(KSgammaI_U0U1)
  REALLOC_v_CALL_v(KSgammaI_U1U2)
  REALLOC_v_CALL_v(KSgammaI_U1U1)
  REALLOC_v_CALL_v(KSgammaI_U2U2)
  ...
  ADD_FIELD(KSB_D1)
  ADD_FIELD(KSB_D2)
  REALLOC_v_CALL_v(KSB_D0)
  REALLOC_v_CALL_v(KSB_D1)
  REALLOC_v_CALL_v(KSB_D2)
...
static void populating_KSGamma(Patch_T *const patch)
{
  ...
  REALLOC_v_CALL_v(KSGamma_U2D1D1)
  REALLOC_v_CALL_v(KSGamma_U2D1D2)
  REALLOC_v_CALL_v(KSGamma_U0D1D1)
  REALLOC_v_CALL_v(KSGamma_U2D0D2)
  REALLOC_v_CALL_v(KSGamma_U2D2D2)
  REALLOC_v_CALL_v(KSGamma_U0D1D2)
  REALLOC_v_CALL_v(KSGamma_U0D0D2)
  REALLOC_v_CALL_v(KSGamma_U0D0D1)
  REALLOC_v_CALL_v(KSGamma_U0D0D0)
  REALLOC_v_CALL_v(KSGamma_U1D2D2)
  REALLOC_v_CALL_v(KSGamma_U2D0D1)
  REALLOC_v_CALL_v(KSGamma_U0D2D2)
  REALLOC_v_CALL_v(KSGamma_U2D0D0)
  REALLOC_v_CALL_v(KSGamma_U1D0D2)
  REALLOC_v_CALL_v(KSGamma_U1D1D2)
  REALLOC_v_CALL_v(KSGamma_U1D0D0)
  REALLOC_v_CALL_v(KSGamma_U1D0D1)
  REALLOC_v_CALL_v(KSGamma_U1D1D1)
