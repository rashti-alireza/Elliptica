...
static void populate_KSgammas_KSalpha_KSBeta(Patch_T *const patch)
{
  ...
  PREP_FIELD(KSgamma_D2D2)
  PREP_FIELD(KSgamma_D0D2)
  PREP_FIELD(KSgamma_D0D0)
  PREP_FIELD(KSgamma_D0D1)
  PREP_FIELD(KSgamma_D1D2)
  PREP_FIELD(KSgamma_D1D1)
  PREP_FIELD(KSgammaI_U0U2)
  PREP_FIELD(KSgammaI_U0U0)
  PREP_FIELD(KSgammaI_U0U1)
  PREP_FIELD(KSgammaI_U1U2)
  PREP_FIELD(KSgammaI_U1U1)
  PREP_FIELD(KSgammaI_U2U2)
...
static void populating_KSGamma(Patch_T *const patch)
{
  ...
  PREP_FIELD(KSGamma_U2D1D1)
  PREP_FIELD(KSGamma_U2D1D2)
  PREP_FIELD(KSGamma_U0D1D1)
  PREP_FIELD(KSGamma_U2D0D2)
  PREP_FIELD(KSGamma_U2D2D2)
  PREP_FIELD(KSGamma_U0D1D2)
  PREP_FIELD(KSGamma_U0D0D2)
  PREP_FIELD(KSGamma_U0D0D1)
  PREP_FIELD(KSGamma_U0D0D0)
  PREP_FIELD(KSGamma_U1D2D2)
  PREP_FIELD(KSGamma_U2D0D1)
  PREP_FIELD(KSGamma_U0D2D2)
  PREP_FIELD(KSGamma_U2D0D0)
  PREP_FIELD(KSGamma_U1D0D2)
  PREP_FIELD(KSGamma_U1D1D2)
  PREP_FIELD(KSGamma_U1D0D0)
  PREP_FIELD(KSGamma_U1D0D1)
  PREP_FIELD(KSGamma_U1D1D1)
