...
void bbn_update_psi10A_UiUj(Patch_T *const patch)
{
  ...
  add_field_and_get_field(_LBij_U0U1)
  add_field_and_get_field(_LBij_U0U0)
  add_field_and_get_field(_LBij_U0U2)
  add_field_and_get_field(_LBij_U1U1)
  add_field_and_get_field(_LBij_U1U2)
  add_field_and_get_field(_LBij_U2U2)
