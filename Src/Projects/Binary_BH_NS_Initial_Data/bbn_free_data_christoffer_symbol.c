...
void bbn_free_data_Gamma(Grid_T *const grid)
{
  ...
  for(p = 0; p < np; ++p)
  {
    ...
    REALLOC_v_CALL_v(_Gamma_U2D1D1)
    REALLOC_v_CALL_v(_Gamma_U2D1D2)
    REALLOC_v_CALL_v(_Gamma_U0D1D1)
    REALLOC_v_CALL_v(_Gamma_U2D0D2)
    REALLOC_v_CALL_v(_Gamma_U2D2D2)
    REALLOC_v_CALL_v(_Gamma_U0D1D2)
    REALLOC_v_CALL_v(_Gamma_U0D0D2)
    REALLOC_v_CALL_v(_Gamma_U0D0D1)
    REALLOC_v_CALL_v(_Gamma_U0D0D0)
    REALLOC_v_CALL_v(_Gamma_U1D2D2)
    REALLOC_v_CALL_v(_Gamma_U2D0D1)
    REALLOC_v_CALL_v(_Gamma_U0D2D2)
    REALLOC_v_CALL_v(_Gamma_U2D0D0)
    REALLOC_v_CALL_v(_Gamma_U1D0D2)
    REALLOC_v_CALL_v(_Gamma_U1D1D2)
    REALLOC_v_CALL_v(_Gamma_U1D0D0)
    REALLOC_v_CALL_v(_Gamma_U1D0D1)
    REALLOC_v_CALL_v(_Gamma_U1D1D1)
