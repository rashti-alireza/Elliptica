...
void bbn_calculate_constraints_2nd(Grid_T *const grid)
{
  ...
  for(p = 0; p < np; ++p)
  {
    ...
    if(IsItInsideBHPatch(patch))
       ...
       /* declaring: */
       PREP_FIELD(ham_constraint_2nd)
       PREP_FIELD(mom_constraint_2nd_U1)
       PREP_FIELD(mom_constraint_2nd_U0)
       PREP_FIELD(mom_constraint_2nd_U2)
       GET_FIELD(K_UiUj_U2U2)
       GET_FIELD(K_UiUj_U1U2)
       GET_FIELD(K_UiUj_U1U1)
       GET_FIELD(K_UiUj_U0U2)
       GET_FIELD(K_UiUj_U0U1)
       GET_FIELD(K_UiUj_U0U0)
       GET_FIELD_UNUSED(dK_UiUj_U0U0D2)
       GET_FIELD_UNUSED(dK_UiUj_U0U0D0)
       GET_FIELD_UNUSED(dK_UiUj_U0U0D1)
       GET_FIELD_UNUSED(dK_UiUj_U1U1D2)
       GET_FIELD_UNUSED(dK_UiUj_U1U1D0)
       GET_FIELD_UNUSED(dK_UiUj_U1U1D1)
       GET_FIELD_UNUSED(dK_UiUj_U0U2D0)
       GET_FIELD_UNUSED(dK_UiUj_U0U2D1)
       GET_FIELD_UNUSED(dK_UiUj_U0U2D2)
       GET_FIELD_UNUSED(dK_UiUj_U1U2D1)
       GET_FIELD_UNUSED(dK_UiUj_U1U2D0)
       GET_FIELD_UNUSED(dK_UiUj_U2U2D0)
       GET_FIELD_UNUSED(dK_UiUj_U1U2D2)
       GET_FIELD_UNUSED(dK_UiUj_U2U2D1)
       GET_FIELD_UNUSED(dK_UiUj_U2U2D2)
       GET_FIELD_UNUSED(dK_UiUj_U0U1D2)
       GET_FIELD_UNUSED(dK_UiUj_U0U1D1)
       GET_FIELD_UNUSED(dK_UiUj_U0U1D0)
       GET_FIELD(psi)
       GET_FIELD(gamma_D1D1)
       GET_FIELD(gamma_D0D1)
       GET_FIELD(gamma_D0D2)
       GET_FIELD(gamma_D1D2)
       GET_FIELD(gamma_D0D0)
       GET_FIELD(gamma_D2D2)
       ...
       GET_FIELD(Gamma_U1D0D0)
       GET_FIELD(Gamma_U0D2D2)
       GET_FIELD(Gamma_U1D0D2)
       GET_FIELD(Gamma_U2D1D2)
       GET_FIELD(Gamma_U1D0D1)
       GET_FIELD(Gamma_U1D2D2)
       GET_FIELD(Gamma_U2D0D2)
       GET_FIELD(Gamma_U2D0D0)
       GET_FIELD(Gamma_U0D0D1)
       GET_FIELD(Gamma_U0D0D0)
       GET_FIELD(Gamma_U2D0D1)
       GET_FIELD(Gamma_U0D0D2)
       GET_FIELD(Gamma_U2D2D2)
       GET_FIELD(Gamma_U1D1D1)
       GET_FIELD(Gamma_U0D1D1)
       GET_FIELD(Gamma_U0D1D2)
       GET_FIELD(Gamma_U1D1D2)
       GET_FIELD(Gamma_U2D1D1)
       GET_FIELD_UNUSED(dGamma_U1D0D1D2)
       GET_FIELD_UNUSED(dGamma_U1D2D2D2)
       GET_FIELD_UNUSED(dGamma_U1D0D1D0)
       GET_FIELD_UNUSED(dGamma_U1D0D1D1)
       GET_FIELD_UNUSED(dGamma_U2D0D2D2)
       GET_FIELD_UNUSED(dGamma_U2D1D1D2)
       GET_FIELD_UNUSED(dGamma_U2D0D0D1)
       GET_FIELD_UNUSED(dGamma_U1D0D0D2)
       GET_FIELD_UNUSED(dGamma_U1D0D0D1)
       GET_FIELD_UNUSED(dGamma_U1D0D0D0)
       GET_FIELD_UNUSED(dGamma_U1D2D2D1)
       GET_FIELD_UNUSED(dGamma_U1D0D2D1)
       GET_FIELD_UNUSED(dGamma_U1D0D2D0)
       GET_FIELD_UNUSED(dGamma_U1D0D2D2)
       GET_FIELD_UNUSED(dGamma_U0D1D1D2)
       GET_FIELD_UNUSED(dGamma_U0D1D1D0)
       GET_FIELD_UNUSED(dGamma_U0D1D1D1)
       GET_FIELD_UNUSED(dGamma_U2D0D1D2)
       GET_FIELD_UNUSED(dGamma_U0D1D2D1)
       GET_FIELD_UNUSED(dGamma_U0D1D2D0)
       GET_FIELD_UNUSED(dGamma_U0D1D2D2)
       GET_FIELD_UNUSED(dGamma_U2D2D2D0)
       GET_FIELD_UNUSED(dGamma_U2D2D2D1)
       GET_FIELD_UNUSED(dGamma_U2D2D2D2)
       GET_FIELD_UNUSED(dGamma_U1D2D2D0)
       GET_FIELD_UNUSED(dGamma_U0D0D2D0)
       GET_FIELD_UNUSED(dGamma_U0D0D2D1)
       GET_FIELD_UNUSED(dGamma_U0D0D2D2)
       GET_FIELD_UNUSED(dGamma_U2D0D1D0)
       GET_FIELD_UNUSED(dGamma_U1D1D2D0)
       GET_FIELD_UNUSED(dGamma_U1D1D2D1)
       GET_FIELD_UNUSED(dGamma_U1D1D2D2)
       GET_FIELD_UNUSED(dGamma_U1D1D1D1)
       GET_FIELD_UNUSED(dGamma_U0D0D0D2)
       GET_FIELD_UNUSED(dGamma_U2D1D1D1)
       GET_FIELD_UNUSED(dGamma_U0D0D0D0)
       GET_FIELD_UNUSED(dGamma_U0D0D0D1)
       GET_FIELD_UNUSED(dGamma_U2D1D1D0)
       GET_FIELD_UNUSED(dGamma_U0D0D1D2)
       GET_FIELD_UNUSED(dGamma_U0D0D1D1)
       GET_FIELD_UNUSED(dGamma_U0D0D1D0)
       GET_FIELD_UNUSED(dGamma_U0D2D2D2)
       GET_FIELD_UNUSED(dGamma_U1D1D1D2)
       GET_FIELD_UNUSED(dGamma_U0D2D2D0)
       GET_FIELD_UNUSED(dGamma_U0D2D2D1)
       GET_FIELD_UNUSED(dGamma_U2D0D0D2)
       GET_FIELD_UNUSED(dGamma_U2D1D2D2)
       GET_FIELD_UNUSED(dGamma_U2D0D1D1)
       GET_FIELD_UNUSED(dGamma_U2D1D2D0)
       GET_FIELD_UNUSED(dGamma_U2D0D2D0)
       GET_FIELD_UNUSED(dGamma_U2D0D2D1)
       GET_FIELD_UNUSED(dGamma_U1D1D1D0)
       GET_FIELD_UNUSED(dGamma_U2D0D0D0)
       GET_FIELD_UNUSED(dGamma_U2D1D2D1)
       GET_FIELD(_E)
       GET_FIELD(_J_U0)
       GET_FIELD(_J_U1)
       GET_FIELD(_J_U2)
