...
static void compute_induced_metric_on_S2_CS_Ylm_CTS(Grid_T *const grid,const char *const type,const unsigned lmax,double **const ph_D0D0,double **const ph_D0D1,double **const ph_D1D1);
