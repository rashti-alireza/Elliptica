...
typedef struct TOV_PROJECT_T
{
 ...
 double *m0; /* Rest-mass at each point */
 ...
 double *e; /* total energy density at each point */
 double *rho0; /* rest-mass density at each point */
 double *h;/* enthalpy at each point */
 double *eps; /* Specific internal energy at each point */
